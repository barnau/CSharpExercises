...
namespace CSharpExercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Assert("IsInLeapYear(new DateTime(1904, 2, 4)) should return true", Exercises.IsInLeapYear(new DateTime(1904, 2, 4)) == true);
            ...
            Assert("GetOccurences(\"Hello World!\", \"World\") should return 1", Exercises.GetOccurences("Hello World!", "World") == 1);
            Console.WriteLine(Exercises.GetOccurences("Hello World!", "World"));
            /* Prompt user to exit */
